...
<div class="card card-default">
  <div class="card-header">
    <h2 class="mb-0">공지글 쓰기</h2>
  </div>

  <div class="card-body">
    <form method="post" action="${pageContext.request.contextPath}/board/notice">
      ...
      <div class="d-flex justify-content-end">
        <a href="${pageContext.request.contextPath}/board/notice" class="btn btn-light mr-2">취소</a>
